...
namespace TaskManager.MonitorTasks
{
    ...
    /// </summary>
    public class TaskManageErrorSendTask : BaseDllTask
    {
        ...
        private void SendEmail(List<tb_senderror_model> errors, string email)
        {
            if (this.AppConfig == null)
            {
                ...
                this.AppConfig.Add("sendmailhost", "smtp.outlook.com");
                this.AppConfig.Add("sendmailname", "vongzh@outlook.com");
                this.AppConfig.Add("password", "Wz926494");
            }
