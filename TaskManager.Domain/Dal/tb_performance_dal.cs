...
namespace TaskManager.Domain.Dal
{
    ...
    {
        public int AddOrUpdate(DbConn conn, tb_performance_model model)
        {
        ...
        public List<tb_performanceinfo_model> GetAllWithTask(DbConn conn, string nodeid, string taskid, string orderby, DateTime? lastupdatetime)
        {
            return SqlHelper.Visit(ps =>
            {
        ...
        public List<tb_performanceinfo_model> GetAllWithNode(DbConn conn, string orderby, DateTime? lastupdatetime)
        {
            return SqlHelper.Visit(ps =>
            {
                StringBuilder stringSql = new StringBuilder();
